...
image = (
    ...
    # data/uploads/ is created at runtime by ingestor._upload_dir() —
    # no mount needed; baking a local snapshot into the image would give
    # the container stale data and not provide real persistence across restarts.
)
